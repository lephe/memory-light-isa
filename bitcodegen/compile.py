...
from bitcodegen.enum import ValueType
from bitcodegen.lexer import Lexer
from bitcodegen.parser import Parser
from bitcodegen.util import huffman
...
def compile_asm(s, *, generate_tree=False):
    ...
    par = Parser(gen_lex, possible_transition, asr_specs, type_specs)
